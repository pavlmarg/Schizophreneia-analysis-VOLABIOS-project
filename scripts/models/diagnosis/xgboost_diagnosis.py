...
# MODEL EVALUATION VIA 5-FOLD CV 
cv_auc_scores = []
cv_f1_scores = []
cv_precision_scores = []
cv_recall_scores = []
...
for train_idx, val_idx in skf.split(X_train_final, y_train):
    ...
    clf_cv = xgb.XGBClassifier(random_state=42, n_jobs=-1, eval_metric='logloss', learning_rate=0.03, n_estimators=150, max_depth=2)
...
summary = {
    'Algorithm': 'XGBoost',
    'Parameters': "{learning_rate = 0.03, max_depth = 3, n_estimators = 150}",
